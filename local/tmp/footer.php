...
<!-- core -->
  <script src="/local/tmp/libs/jQuery-Storage-API/jquery.storageapi.min.js"></script>
  <script src="/local/tmp/libs/jquery.stellar/jquery.stellar.min.js"></script>
  <script src="/local/tmp/libs/owl.carousel/dist/owl.carousel.min.js"></script>
  <script src="/local/tmp/libs/jscroll/jquery.jscroll.min.js"></script>
  <script src="/local/tmp/libs/PACE/pace.min.js"></script>
  <script src="/local/tmp/libs/jquery-pjax/jquery.pjax.js"></script>
  ...
  <script src="/local/tmp/js/ui-load.js"></script>
  <script src="/local/tmp/js/ui-jp.js"></script>
  <script src="/local/tmp/js/ui-include.js"></script>
  <script src="/local/tmp/js/ui-device.js"></script>
  <script src="/local/tmp/js/ui-form.js"></script>
  <script src="/local/tmp/js/ui-nav.js"></script>
  <script src="/local/tmp/js/ui-screenfull.js"></script>
  <script src="/local/tmp/js/ui-scroll-to.js"></script>
  <script src="/local/tmp/js/ui-toggle-class.js"></script>
  <script src="/local/tmp/js/ui-taburl.js"></script>
